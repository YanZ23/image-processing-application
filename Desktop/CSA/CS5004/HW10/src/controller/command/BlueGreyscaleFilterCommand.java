...
/**
 * The command that uses filter to transform an image into blue greyscale.
 */
public class BlueGreyscaleFilterCommand implements ICommand {
  private final IImageDataBase model;

  /**
   * Instantiates a new BlueGreyscaleFilterCommand with the specified image database.
   *
   * @param model The image database to store and retrieve images.
   */
  public BlueGreyscaleFilterCommand(IImageDataBase model) {
    this.model = model;
  }
