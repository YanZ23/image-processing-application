...
/**
 * The implementation of IImageLoader to load images from JPG format files.
 */
public class JPGImageLoader implements IImageLoader {
  ...
  /**
   * Constructs a JPGImageLoader with the specified file path and output appendable.
   *
   * @param filePath The path to the JPG format file.
   * @param output   The appendable used to display messages during image loading.
   */
  public JPGImageLoader(String filePath, StringAppendable output) {
