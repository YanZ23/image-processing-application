...
/**
 * The implementation of IImageSaver to save images to JPG format files.
 */
public class JPGImageSaver implements IImageSaver {
  ...
  /**
   * Constructs a JPGImageSaver with the specified file path and output appendable.
   *
   * @param pathToSave The path where the JPG format file will be saved.
   * @param output     The appendable used to display messages during image saving.
   */
  public JPGImageSaver(String pathToSave, StringAppendable output) {
